...
export default class extends Component {
  ...
  static getDerivedStateFromProps(nextProps, prevState) {
    if (nextProps.error !== prevState.error ||
      ...
      nextProps.underlineDuration !== prevState.underlineDuration) {
  ...
  componentDidUpdate(prevProps, prevState) {
    if (prevProps.error !== this.props.error || prevProps.focused !== this.props.focused || prevProps.underlineDuration !== this.props.underlineDuration) {

      let { animatedScaleX, animatedOpacity } = this.state
      let { error, focused, underlineDuration } = this.props

      if (prevProps !== focused || prevProps !== error) {
